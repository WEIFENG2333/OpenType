    ...
    <div>
      <div className="flex items-center gap-2 mb-3">
        ...
        <div className="relative">
          ...
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4"/><circle cx="12" cy="8" r="0.5" fill="currentColor" stroke="none"/></svg>
          </button>
          {showTooltip && (
